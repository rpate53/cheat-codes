...
\begin{multicols*}{2}
    ...
    \input{sections/1_transformer_models.tex}
    % 2. Using Transformers
    \input{sections/2_using_transformers.tex}
    % 3. Fine-Tuning a Pretrained Model
    \input{sections/3_fine_tuning_pretrained_model.tex}
    ...
    \input{sections/7_classical_nlp_tasks.tex}
